...
class Dataset(Base):
    ...
    has_harvest__created_at = Column(Boolean, default=False)
    has_harvest__modified_at = Column(Boolean, default=False)
    has_harvest__remote_id = Column(Boolean, default=False)
    has_harvest__remote_url = Column(Boolean, default=False)
    has_resources__total = Column(Boolean, default=False)
    has_spatial__zones = Column(Boolean, default=False)
    has_spatial__geom = Column(Boolean, default=False)
    has_temporal_coverage = Column(Boolean, default=False)
    has_frequency = Column(Boolean, default=False)
    has_contact_point = Column(Boolean, default=False)
    ...
    consistent_dates = Column(Boolean, default=False)
    consistent_temporal_coverage = Column(Boolean, default=False)
